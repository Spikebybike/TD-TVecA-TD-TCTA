...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%------------------------------------------------------------------
% Input:  S: sparse range slice
%         P,Q: pencil parameters for TCT transformation
%         mu: penalty parameter
%         max_iter_K: iterations K
%         e_rank: estimated rank
% Output: X_completed: completed range slice
%-------------------------------------------------------------------
function X_completed = TCTA(S, P, Q, mu, max_iter_K,e_rank)

% initialization
mask=S~=0;
mask=double(mask);      % mask of matrix
